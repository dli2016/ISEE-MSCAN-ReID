...
EXTRA_LDFLAGS = ./lib/libcaffe.so

INC_DIR   = /usr/local/cuda/include /home/da.li/local/protobuf/include ./src/caffe/include ./src ./include
...
SUFFIX       = c cpp cc cxx
TARGET       := out/libisee_mscan_reid.so
